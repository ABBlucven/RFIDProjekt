...
export default {
  ...
  firebase: {
    //documents: this.classID == null ? "" : db.ref('students/classes/' + this.classID),
  ...
  mounted: {
    //documents: this.classID == null ? "" : db.ref('students/classes/' + classID),
